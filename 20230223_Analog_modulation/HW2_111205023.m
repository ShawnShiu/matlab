...
m2 = sawtooth(2*pi*fs*t).*carr_q;
subplot(4,2,1);
plot(t,square(2*pi*fs*t));  title('m1(t)');  grid on;
subplot(4,2,2);
plot(t,sawtooth(2*pi*fs*t));  title('m2(t)');  grid on;
subplot(4,2,3);
plot(t,m1);  title('m1(t) modulation');  grid on;
subplot(4,2,4);
plot(t,imag(1i*m2));  title('m2(t) modulation');  grid on;
...
subplot(4,2,6);
plot(t,imag(yt2));  title('y2(t)');  grid on;
...
subplot(4,2,8);
plot(imag(z1)); title('LPF(y(t)) and get m2(t)');   grid on;
